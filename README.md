...
| **Org IT Toolkit** | [ai-finops-report](skills/AI%20Implement/skills/cost/ai-finops-report/SKILL.md) — turns Cowork/Neptune consumption CSV exports into Word + Excel + HTML FinOps insight reports · [cowork-plugin-builder](skills/personal%20productivity/skills/development/cowork-plugin-builder/SKILL.md) — scaffolds & packages new Cowork plugins into sideload-ready zips | [org-it-toolkit-1.3.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/AI%20Implement/plugins/org-it-toolkit/dist/org-it-toolkit-1.3.0.zip) |
...
| **GitHub Toolkit** | [github-repo-workflow](skills/personal%20productivity/skills/development/github-repo-workflow/SKILL.md) — connects Cowork to GitHub's official remote MCP server (`https://api.githubcopilot.com/mcp/`, OAuth) for repos, code search, issues, PRs, Actions, and security alerts | [github-mcp-1.0.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/personal%20productivity/plugins/github-mcp/dist/github-mcp-1.0.0.zip) |
