...
| [cowork-plugin-builder](skills/personal%20productivity/skills/development/cowork-plugin-builder/SKILL.md) | Scaffolds, validates, and packages a M365 Copilot Cowork plugin end-to-end into a sideload-ready zip — 5-field `SKILL.md` frontmatter, devPreview manifest with `agentSkills` + remote MCP `agentConnectors`, icon generation, and forward-slash packaging — with the known validation gotchas baked in. Ships `package-plugin.ps1` + `new-icons.ps1`. |
| [github-repo-workflow](skills/personal%20productivity/skills/development/github-repo-workflow/SKILL.md) | Grounds answers about repos, code, issues, PRs, commits, Actions runs, and security alerts in the live state of GitHub via the official GitHub remote MCP server. Enforces read-before-write, scoped search qualifiers, commit-SHA permalink citations, and explicit confirmation before any create/merge/close operation. |
...
| ------- | ----- | -------- |
| **Org User Toolkit** | [copilot-cost-advisor](skills/AI%20Implement/skills/cost/copilot-cost-advisor/SKILL.md) — routes each task to the cheapest capable option before Cowork credits are spent | [org-user-toolkit-1.0.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/AI%20Implement/plugins/org-user-toolkit/dist/org-user-toolkit-1.0.0.zip) |
| **Org IT Toolkit** | [ai-finops-report](skills/AI%20Implement/skills/cost/ai-finops-report/SKILL.md) — turns Cowork/Neptune consumption CSV exports into Word + Excel + HTML FinOps insight reports · [cowork-plugin-builder](skills/personal%20productivity/skills/development/cowork-plugin-builder/SKILL.md) — scaffolds & packages new Cowork plugins into sideload-ready zips | [org-it-toolkit-1.5.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/AI%20Implement/plugins/org-it-toolkit/dist/org-it-toolkit-1.5.0.zip) |
...
| **GitHub Toolkit** | [github-repo-workflow](skills/personal%20productivity/skills/development/github-repo-workflow/SKILL.md) — connects Cowork to GitHub's official remote MCP server (`https://api.githubcopilot.com/mcp/`, OAuth) for repos, code search, issues, PRs, Actions, and security alerts | [github-mcp-1.3.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/personal%20productivity/plugins/github-mcp/dist/github-mcp-1.3.0.zip) |
