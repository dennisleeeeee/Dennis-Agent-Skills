...
| **Org IT Toolkit** | [ai-finops-report](skills/AI%20Implement/skills/cost/ai-finops-report/SKILL.md) — turns Cowork/Neptune consumption CSV exports into Word + Excel + HTML FinOps insight reports · [cowork-plugin-builder](skills/AI%20Implement/skills/development/cowork-plugin-builder/SKILL.md) — scaffolds & packages new Cowork plugins into sideload-ready zips | [org-it-toolkit-1.1.0.zip](https://github.com/dennisleeeeee/Dennis-Agent-Skills/raw/main/skills/AI%20Implement/plugins/org-it-toolkit/dist/org-it-toolkit-1.1.0.zip) |
